...
data = pd.read_csv("/content/development.csv")
texts = data["tweet"].tolist()
labels = data["profession"].tolist()
...
label_map = {"politician": 0, "celebrity": 1, "journalist": 2}  # Cambiado a tres etiquetas
...
for epoch in range(7):  # Ajusta el número de épocas según sea necesario
    model.train()
    total_loss = 0
